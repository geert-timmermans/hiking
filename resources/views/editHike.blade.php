                ...
                <form action="{{ route('editHikePost', $hike->id) }}" method="post" class="d-flex flex-column align-items-center">
                    <div class="row">
                        ...
                        <div class="form-group col-10 offset-1 col-md-5 offset-md-1">
                            ...
                            <input type="text" class="form-control font-weight-bold" id="duration" name="duration" value="{{ $hike->duration }}" maxlength="8">
                        </div>
                        <div class="form-group col-10 offset-1 col-md-5 offset-md-0">
                            <label for="distance">Distance (km)</label>
                            <input type="number" class="form-control font-weight-bold" id="distance" name="distance" value="{{ $hike->distance }}" step=".01" maxlength="4">
                        </div>
                        <div class="form-group col-10 offset-1 col-md-5 offset-md-1">
                            <label for="avg_speed">Avg Speed (km/h)</label>
                            <input type="number" class="form-control font-weight-bold" id="avg_speed" name="avg_speed" value="{{ $hike->avg_speed }}" step=".1" maxlength="4">
                        </div>
                        <div class="form-group col-10 offset-1 col-md-5 offset-md-0">
                            <label for="kcal">Kcal</label>
                            <input type="number" class="form-control font-weight-bold" id="kcal" name="kcal" value="{{ $hike->kcal }}" maxlength="4">
                        </div>
                        <div class="form-group col-10 offset-1 col-md-5 offset-md-1">
                            <label for="steps">Steps</label>
                            <input type="number" class="form-control font-weight-bold" id="steps" name="steps" value="{{ $hike->steps }}" maxlength="5">
                        </div>
                        <div class="form-group col-10 offset-1 col-md-5 offset-md-0">
                            <label for="week">Week</label>
                            <input type="number" class="form-control font-weight-bold" id="week" name="week" value="{{ $hike->week }}" maxlength="2">
                        </div>
                        <div class="form-group col-10 offset-1 col-md-5 offset-md-1">
                            <label for="month">Month</label>
                            <input type="number" class="form-control font-weight-bold" id="month" name="month" value="{{ $hike->month }}" maxlength="2">
                        </div>
                        <div class="form-group col-10 offset-1 col-md-5 offset-md-0">
                            <label for="date">Date</label>
                            <input type="date" class="form-control font-weight-bold" id="date" name="date" value="{{ $hike->date }}">
                        </div>
                    </div>
